      ...
      <div className="p-6">
        ...
        {state === 'done' && (
          <div>
            ...
            <Link href="/toko/toko-rizky?demo=true" className="btn-primary w-full flex items-center justify-center gap-2 text-sm py-3">
  ...
  return (
    <div className="bg-gray-900 rounded-2xl p-5 shadow-2xl border border-white/5">
      ...
      <div className="bg-gray-950 rounded-xl p-4 mb-3">
        <p className="text-[9px] text-gray-600 uppercase tracking-widest font-bold mb-1">Marketplace Cost Dihindari</p>
        <p className="text-3xl font-extrabold text-white tracking-tight leading-none mb-1">{formatRpShort(animSavings)}</p>
        <p className="text-[10px] text-green-400 flex items-center gap-1">
          <TrendingUp size={9} /> hemat vs Tokopedia bulan ini
        </p>
            ...
            <div>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  'Revenue vs biaya marketplace langsung terhitung',
      ...
      <section className="max-w-3xl mx-auto px-6 py-20">
        ...
        <div className="mt-16 text-center">
          ...
          <p className="mt-4 text-sm text-gray-400">
            Atau{' '}
            <Link href="/toko/toko-rizky" className="text-app-blue hover:underline">lihat demo store →</Link>
          </p>
        </div>
      </section>
          ...
          <div className="flex flex-col md:flex-row items-start justify-between gap-8 mb-8">
            ...
            <div className="grid grid-cols-2 gap-x-12 gap-y-2">
              {[
                ...
                { label: 'Demo Store', href: '/toko/toko-rizky' },
